...
class CarController extends Controller
{
        ...
        return $this->checkProcess(
            ...
            function () use ($data) {
                if (!Car::create($data)) {
                    ...
                    throw new \Exception('Faild To change Car Data');
                }
    ...
    public function update(CarRequest $request, Car $car)
    {
        ...
        return $this->checkProcess(
            ...
            function () use ($car, $data) {
                if (!$car->update($data)) throw new \Exception('Car Data Faild To change');
    ...
    {
        $failedMessage = "Car data faild to Delete";
    ...
    {
        $car = $this->getOneDeletedCars($platNumber);
        $failedMessage = 'Car data faild to restore';

        return $this->checkProcess(
            self::ROUTE_TRASH,
            'Car Data restore Successfully',
            function () use ($car, $failedMessage) {
    ...
    public function forceDelete(string $platNumber)
    {
        ...
        return $this->checkProcess(
            self::ROUTE_TRASH,
            'Car Data is permanently Deleted',
            function () use ($car, $image) {
                if ($car->forceDelete()) {
                    $this->deleteImage($image);
                } else {
                    throw new \Exception('Error To delete car data');
                }
