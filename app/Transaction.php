...
class Transaction extends Model
{
    ...
    {
        if ($this->getTransactionStatusCompleted()) return ['text-success', 'Complete'];

        if ($this->getTransactionStatusOnGoing()) return ['text-primary', 'Running'];

        if ($this->getTransactionStatusLate()) return ['text-danger', 'Late'];
    }
