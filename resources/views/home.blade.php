...
@section('title', 'Car Connect Dashboard')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="{{ route('transactions.index', ['status' => '>']) }}"
                        ...
                        <h4 class="small font-weight-bold mb-4">Transaction Running
                            <span class="float-right">{{ countOfTransactionStatus('>') }}</span>
                        </h4>
                    </a>
                    <a href="{{ route('transactions.index', ['status' => '<']) }}"
                        class="text-decoration-none text-dark">
                        <h4 class="small font-weight-bold mb-4">Transaction Late
                            <span class="float-right">{{ countOfTransactionStatus('<') }}</span>
                        </h4>
                    </a>
                    <a href="{{ route('transactions.index', ['status' => 'COMPLETED']) }}"
                        class="text-decoration-none text-dark">
                        <h4 class="small font-weight-bold mb-4">Transaction Complete
