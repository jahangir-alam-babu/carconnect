...
<head>
    ...
    <title>Nota Transaction</title>
</head>

<body class="py-3">
    <h1 class="text-center">NOTA Transaction</h1>
        ...
        <div class="col-md-8">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        <th scope="row" class="text-left">Tanggal Complete</th>
                    ...
                    <tr>
                        <th scope="row" class="text-left">Total Color</th>
                        <td class="pl-5">
                    ...
                    <tr>
                        <th scope="row" class="text-left">Total KeLatean</th>
                    ...
                    <tr>
                        <th scope="row" class="text-left">Total Color + Total Denda</th>
