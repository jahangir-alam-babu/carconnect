...
@section('title', 'Car Connect Transaction')

@section('content')
<h1 class="mb-3">Daftar Transaction</h1>
...
<div class="row justify-content-center">
    <div class="col-md-12">
        ...
        <a href="{{ route('cars.trash') }}" class="btn btn-warning btn-block my-4">Car Data Terhapus</a>
        @endif --}}
