...
@section('title', 'Car Connect Edit Transaction')
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <form action="{{ route('transactions.update', $transaction) }}" method="POST" class="transaction-form"
                    ...
                    <div class="form-group">
                        <label for="start_date">Tanggal Complete</label>
                        <div class="input-group flatpickr">
                    ...
                    <div class="form-group">
                        <label for="total_late">Total KeLatean</label>
                    ...
                    <div class="form-group">
                        <label for="total_price">
                            Total Color {{ $transaction->total_late ? ' ( + Total Denda )' : ''}}
                        </label>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-default">Rp.</span>
