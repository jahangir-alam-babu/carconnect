        ...
        <div class="card mt-3">
            <div class="row no-gutters">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Tanggal Complete : <span class="font-weight-bold">{{ $transaction->finish_date_with_day }}</span>
                    </p>
                    ...
                    <p class="card-text">
                        Total KeLatean : <span class="font-weight-bold price">
                    ...
                    @endif
                    <p class="card-text">
                        Total Color {{ $transaction->total_late && $transaction->updated_by ? '( + Total Denda)' : '' }}
                        :
                ...
                <div class="col-md-3 pl-4">
                    <p class="card-text">
                        <small class="text-muted">
                            DiMake a oleh : {{ createdUpdatedDeletedBy($transaction->created_by) }}
                        </small>
                    </p>
                </div>
                @if ($transaction->updated_by)
