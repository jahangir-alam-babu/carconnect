            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('transactions.restore', $transaction->invoice_number) }}"
                        ...
                        onclick="return confirm('Yakin ingin mengembalikan data Transaction customer {{ $transaction->customer->name }} ?')">Restore</a>
                    @endif
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">
                                    Hapus Transaction {{ $type === 'trash' ? 'permanen' : '' }}
                                </h5>
                            ...
                            <div class="modal-body">
                                <p>
                                    Apakah anda yakin ingin menghapus Transaction customer <strong>
            ...
            <tr>
                <td colspan="8">
                    <p class="font-weight-bold text-center text-monospace">
                        Car Data {{ $type === 'trash' ? ' terhapus ' : '' }} empty
                    </p>
                </td>
            </tr>
            @endforelse
