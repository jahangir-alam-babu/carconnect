                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="card-text">
                                    Numbar Plate : <span class="font-weight-bold">{{ $car->plat_number }}</span>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-text">Color : {{ $car->years }}</p>
                                <p class="card-text">
                                    Color : <span class="font-weight-bold price">{{ currencyFormat($car->price)
                                        }}</span>
                                </p>
                                <p class="card-text">
                                    Status :
                ...
                <div class="col-md-3 pl-4">
                    <p class="card-text">
                        <small class="text-muted">
                            DiMake a oleh : {{ createdUpdatedDeletedBy($car->created_by) }}
                        </small>
                    </p>
                </div>
                @if ($car->updated_by)
